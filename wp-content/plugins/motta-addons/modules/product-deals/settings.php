...
class Settings {
	...
	public function add_deal_fields() {
        ...
        <p class="form-field _deal_quantity_field">
            <label for="_sale_quantity"><?php esc_html_e( 'Sale quantity', 'motta-addons' ) ?></label>
			<?php echo wc_help_tip( __( 'Set this quantity will make the product to be a deal. The sale will end when this quantity is sold out.', 'motta-addons' ) ); ?>
        ...
        <p class="form-field _deal_sales_counts_field">
            <label for="_sale_quantity"><?php esc_html_e( 'Sold Items', 'motta-addons' ) ?></label>
			<?php echo wc_help_tip( __( 'Set this sold items should be less than the sale quantity.', 'motta-addons' ) ); ?>
	...
	public function product_deals_section( $sections ) {
		$sections['motta_product_deals'] = esc_html__( 'Product Deals', 'motta-addons' );
	...
	public function product_deals_settings( $settings, $section ) {
		if ( 'motta_product_deals' == $section ) {
			$settings = array();

			$settings[] = array(
				'id'    => 'motta_product_deals_options',
				'title' => esc_html__( 'Product Deals', 'motta-addons' ),
				'type'  => 'title',
			);

			$settings[] = array(
				'id'      => 'motta_product_deals',
				'title'   => esc_html__( 'Product Deals', 'motta-addons' ),
				'desc'    => esc_html__( 'Enable Product Deals', 'motta-addons' ),
				'type'    => 'checkbox',
				'default' => 'yes',
			);

			$settings[] = array(
				'id'      => 'motta_product_deals_expire_text',
				'title'   => esc_html__( 'Expire Text', 'motta-addons' ),
				'type'    => 'text',
				'default' => __( 'Hurry up!<br> Sales ends soon!', 'motta-addons' ),
			);

			$settings[] = array(
				'id'      => 'motta_product_deals_sold_items_text',
				'title'   => esc_html__( 'Sold Items Text', 'motta-addons' ),
				'type'    => 'text',
				'default' => esc_html__( 'Sold Items', 'motta-addons' ),
			);

			$settings[] = array(
				'id'      => 'motta_product_deals_sold_text',
				'title'   => esc_html__( 'Sold Text', 'motta-addons' ),
				'type'    => 'text',
				'default' => esc_html__( 'Sold', 'motta-addons' ),
			);
