...
class Product_Meta  {
	...
	const TAXONOMY_TYPE   = 'motta_product_tab_type';
	...
	/**
	 * Add new product data tab for product tabs
	 *
	 * @param array $tabs
	 *
	 * @return array
	...
	public function product_data_tab( $tabs ) {
		...
		$tabs['motta_product_tabs'] = array(
			'label'    => esc_html__( 'Product Tabs', 'motta-addons' ),
			'target'   => 'motta-product-tabs',
			'class'    => array( 'motta-product-tabs', ),
			'priority' => 62,
		);
	...
	public function product_data_panel() {
		...
		global $post;
		?>
		<div id="motta-product-tabs" class="panel wc-metaboxes-wrapper woocommerce_options_panel">
			<div class="wc-metaboxes">
				...
				<?php
					...
					$tab_title = $tab_disable ? $tab_title . '(' . esc_html__( 'Disabled', 'motta-addons' ) . ')' : $tab_title;
				...
				<div class="wc-metabox postbox">
					<h3 class="<?php echo esc_attr($tab_class); ?>" style="border-bottom: 1px solid #ccc">
						<div class="handlediv" title="<?php esc_html_e('Click to toggle', 'motta-addons'); ?>"></div>
					...
					<div class="wc-metabox-content" style="padding: 20px">
						...
						woocommerce_wp_checkbox(
							array(
								...
								'label'       => esc_html__('Tab Disable', 'motta-addons' ),
								'value'       => wc_bool_to_string( $tab_disable ),
							)
						);?>
						<fieldset class="form-field">
							<label><?php esc_html_e( 'Tab Content', 'motta-addons' ); ?></label>
							<?php
