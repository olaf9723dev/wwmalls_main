...
class Frontend {
	...
	public function __construct() {
		...
		add_filter( 'motta_single_product_image_id', array( $this, 'get_variation_image' ) );
		add_filter( 'motta_single_product_gallery_image_ids', array( $this, 'get_variation_gallery_image_ids' ) );

		add_action( 'wc_ajax_motta_get_variation_images', array( $this, 'get_variation_images' ) );
	}
	...
	public function has_variation_images() {
		...
		foreach( $variation_ids as $variation_id ) {
			$variation_images = get_post_meta( $variation_id, 'motta_variation_images', true );
			if( $variation_images ) {
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'motta_variation_images', MOTTA_ADDONS_URL . '/modules/variation-images/js/variation-images-frontend.js', array( 'jquery' ), '20220319', true );
	}

	public function get_variation_images() {
		check_ajax_referer( '_motta_nonce', 'nonce' );
