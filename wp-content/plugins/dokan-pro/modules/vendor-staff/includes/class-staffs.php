...
class Dokan_Staffs {
    ...
    public function link_add_staff_notification_email( $notify_email, $user ) {
        ...
        $message = apply_filters( 'dokan_new_staff_notification_email_message', $message, $user );
        $notify_email['message'] = sprintf( '<!doctype html><html><body>%s</body></html>', wp_kses_post( wpautop( $message ) ) );
        $notify_email['headers'] = 'Content-Type: text/html';
