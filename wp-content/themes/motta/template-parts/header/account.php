...
<div class="header-account">
	<a href="<?php echo esc_url( wc_get_account_endpoint_url( 'dashboard' ) ); ?>" data-toggle="<?php echo esc_attr( $account_data_toggle ) ?>" data-target="account-panel" class="motta-button <?php echo esc_attr( $account_classes ) ?>">
		...
		<span class="motta-button__text <?php echo esc_attr( $account_text_class ); ?>">
			...
			<?php endif; ?>
			<span class="motta-button__text--account"><?php echo esc_html( $account_text ) ?></span>
		</span>
	</a>
