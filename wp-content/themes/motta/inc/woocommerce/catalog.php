...
class Catalog {
	...
	public function body_class( $classes ) {
		...
		$view = Helper::get_option( 'catalog_sidebar' ) == 'no-sidebar' ? 'grid-5' : 'default';
		$catalog_view   = isset( $_COOKIE['catalog_view'] ) ? $_COOKIE['catalog_view'] : $view;
	...
	public function motta_template_redirect() {
		self::$catalog_view = isset( $_COOKIE['catalog_view'] ) ? $_COOKIE['catalog_view'] : 'default';
