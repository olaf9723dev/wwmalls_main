...
<div class="es-listings__wrap-inner js-es-listings__wrap-inner js-es-entities__wrap_inner et_smooth_scroll_disabled">
    ...
    <div data-entity="listings" class="js-es-listings ert-listing js-es-entities es-listings <?php echo $css_layout; ?>" data-layout="<?php echo $css_layout; ?>" data-hash="<?php esc_attr_e( $hash ); ?>">
