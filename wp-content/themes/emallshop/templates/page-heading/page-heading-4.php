	...
	if( $show_breadsrumb == 'yes' || $show_title == 'yes' ):?>
		<div class="page-heading page-heading-4">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<?php if( emallshop_get_option('show-title-breadcrumb-content', 'in-page-heading')=="in-page-heading" && !is_single()):
							if( $show_title == 'yes' ):?>	
								<div class="page-header">
								<?php if(is_woocommerce_activated() && is_woocommerce()){?>
									<h1 class="page-title"><?php woocommerce_page_title(); ?></h1>
								<?php }elseif(is_home()){ ?>
									<h1 class="page-title"> <?php echo esc_html('Blog','emallshop')?> </h1>
						...
						<?php if( emallshop_get_option('show-page-title',1) && emallshop_get_option('show-title-breadcrumb-content','in-page-heading')=="in-page-heading"):
