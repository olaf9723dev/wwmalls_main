 ...
 *
 * @author 	PressLayouts
 * @package emallshop/template/footer
 * @since 3.0
 */
...
<div class="emallshop-mobile-navbar<?php echo esc_attr( $navbar_class );?>">
	<?php 
			...
			<a href="<?php echo esc_url( $menu_item['link'] );?>" class="<?php echo esc_attr($class); ?>">
				<span class="navbar-icon <?php echo esc_attr( $menu_item['icon'] );?>">
					<?php if( isset( $menu_item['count'] ) ){ ?>
						<span class="<?php echo esc_attr($element);?>-count"><?php echo esc_html( $menu_item['count'] );?></span>
					<?php } ?>
				</span>
